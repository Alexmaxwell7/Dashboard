...
const ProviderSalesCard: React.FC<SalesCardProps> = ({
  totalSales,
  comparisonImageSrc,
  ...
  return (
    <section className="flex overflow-hidden flex-col p-3 bg-white rounded-2xl  min-w-[273px]">
...
export default ProviderSalesCard;
