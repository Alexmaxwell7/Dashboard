...
const TicketCard: React.FC<TicketCardProps> = ({ ticket }) => {
  ...
  const actionButtons = [
    { label: "Raise a Ticket", className: "w-[50%] mt-5 px-0 py-0 text-white" },
  ];
    ...
    <article className="flex flex-col justify-center p-4 mt-4 w-full bg-white rounded-2xl shadow-[0px_18px_40px_rgba(112,144,176,0.12)]">
      <div className="flex overflow-hidden flex-col w-full bg-white shadow-[0px_18px_40px_rgba(112,144,176,0.12)]">
        <div className="flex gap-2 justify-between w-full">
          ...
          />
          <div className="flex flex-col my-auto min-w-[110px]">
          ...
          <div className="flex gap-2 self-start mt-1 text-xs font-medium text-center text-stone-800 min-w-[200px]">
        ...
        <div className="flex flex-col mt-3 w-full">
          ...
          <div>
            <h3 className="font-semibold mt-4">Status Pending</h3>
